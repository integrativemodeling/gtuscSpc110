...
po.system.title = "Integrative structure of the yeast gammaTuSC-Spc110 monomer complex"
...
import ihm.dumper
with open('initial_mono.cif', 'w') as fh:
...
m = IMP.Model()
inf1 = RMF.open_rmf_file_read_only('../../results/gtusc_spc110monomer/cluster_center_model.rmf3')
...
loc_density_list={'Spc97.0':['Spc97'],
         ...
         'Tub4.0':['Tub4'],
         'Tub4.1':['Tub4'],
         'Spc110.0':['Spc110-1-163','Spc110-164-203','Spc110-204-220']}
...
for prot in loc_density_list:
      ...
      for domain_density in loc_density_list[prot]:
          loc = ihm.location.OutputFileLocation('../../results/gtusc_spc110monomer/'+domain_density+'.mrc')
...
po.finalize()
with open('gtusc_Spc110_monomer.cif', 'w') as fh:
    ihm.dumper.write(fh, [po.system])

import ihm.reader
with open('gtusc_Spc110_monomer.cif') as fh:
